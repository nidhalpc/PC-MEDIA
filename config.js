...
module.exports = {
    ...
    SESSION: process.env.PC-MEDIA_SESSION === undefined ? '' : process.env.PC-MEDIA_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By PC-MEDIA' : process.env.ALL_CAPTION,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? '  PC-MEDIA࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'PC-MEDIA' : process.env.OWNER_SHIP,
